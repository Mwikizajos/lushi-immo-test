...
function Appartements() {
  ...
  // Fonction pour gérer l'affichage de l'image intelligemment
  const getImageUrl = (imagePath) => {
    if (!imagePath) return "https://via.placeholder.com/400x300";
    
    // Si l'image vient de Cloudinary, elle commence déjà par "http"
    if (imagePath.startsWith("http")) {
      return imagePath;
    }
    
    // Sinon, c'est une ancienne image locale, on ajoute le lien Render
